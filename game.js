...
const SKILLS = {
    slash: {
        id: 'slash', name: '斩击', icon: '⚔️', type: 'melee',
        description: '对周围2.5格内敌人造成伤害',
        damage: 18, range: 2.5, cooldown: 900
    },
    whirlwind: {
        id: 'whirlwind', name: '旋风斩', icon: '🌀', type: 'melee',
        description: '旋转攻击周围3.5格所有敌人',
        damage: 12, range: 3.5, cooldown: 1400
    },
    pistol: {
        id: 'pistol', name: '手枪', icon: '🔫', type: 'ranged',
        description: '向最近敌人发射子弹',
        damage: 15, speed: 10, range: 12, cooldown: 700, projectileCount: 1
    },
    shotgun: {
        id: 'shotgun', name: '霰弹枪', icon: '💥', type: 'ranged',
        description: '扇形散射5发子弹',
        damage: 10, speed: 8, range: 9, cooldown: 1200, projectileCount: 5, spread: 30
    },
    rifle: {
        id: 'rifle', name: '自动步枪', icon: '🎯', type: 'ranged',
        description: '快速连发子弹',
        damage: 8, speed: 12, range: 14, cooldown: 350, projectileCount: 1
    },
    fireball: {
        id: 'fireball', name: '火球术', icon: '🔥', type: 'ranged',
        description: '发射追踪火球，爆炸造成范围伤害',
        damage: 25, speed: 6, range: 11, cooldown: 1500, projectileCount: 1, explosive: true, explosionRadius: 2
    },
    orbit: {
        id: 'orbit', name: '环绕物', icon: '🔮', type: 'orbit',
        description: '2个环绕物保护自身',
        damage: 12, count: 2, radius: 2.5, cooldown: 0
    },
    mine: {
        id: 'mine', name: '地雷', icon: '💣', type: 'mine',
        description: '在身后放置地雷',
        damage: 35, cooldown: 3500, duration: 12000, radius: 2
    },
    lightning: {
        id: 'lightning', name: '闪电链', icon: '⚡', type: 'lightning',
        description: '闪电弹射4个敌人',
        damage: 18, range: 12, cooldown: 1800, chainCount: 4
    }
};
...
const UPGRADE_CARDS = [
    ...
    { id: 'dmg_up', type: 'stat', name: '伤害强化', icon: '💪', description: '伤害 +20%', effect: { damage: 2 } },
    { id: 'spd_up', type: 'stat', name: '攻速强化', icon: '⚡', description: '攻击速度 +15%', effect: { attackSpeed: 0.15 } },
    { id: 'hp_up', type: 'stat', name: '生命强化', icon: '❤️', description: '最大生命 +30', effect: { maxHp: 30 } },
    { id: 'move_up', type: 'stat', name: '移速强化', icon: '💨', description: '移动速度 +20%', effect: { moveSpeed: 0.2 } },
    { id: 'regen_up', type: 'stat', name: '回复强化', icon: '💚', description: '每秒回复 2 HP', effect: { lifeRegen: 2 } },
    { id: 'crit_up', type: 'special', name: '暴击', icon: '💥', description: '暴击率 +10%', effect: { criticalChance: 0.1 } },
    { id: 'xp_up', type: 'special', name: '经验获取', icon: '📚', description: '经验获取 +30%', effect: { xpBonus: 0.3 } }
];

const ENEMY_TYPES = {
    rat: { name: '变异鼠', icon: '🐀', hp: 15, atk: 3, speed: 1.8, xp: 8, gold: 5, size: 0.5, color: '#8B4513' },
    zombie: { name: '丧尸', icon: '🧟', hp: 25, atk: 5, speed: 1.0, xp: 12, gold: 8, size: 0.7, color: '#2ecc71' },
    skeleton: { name: '骷髅', icon: '💀', hp: 20, atk: 7, speed: 1.3, xp: 18, gold: 12, size: 0.7, color: '#ecf0f1' },
    demon: { name: '恶魔', icon: '👹', hp: 40, atk: 10, speed: 1.1, xp: 30, gold: 20, size: 0.9, color: '#e74c3c' },
    golem: { name: '魔像', icon: '🗿', hp: 60, atk: 12, speed: 0.7, xp: 45, gold: 30, size: 1, color: '#7f8c8d' },
    dragon: { name: '幼龙', icon: '🐉', hp: 80, atk: 15, speed: 1.3, xp: 70, gold: 50, size: 1.1, color: '#f39c12' }
};

// Boss类型
const BOSS_TYPES = {
    giant_zombie: { name: '巨型丧尸', icon: '🧟‍♂️', hp: 500, atk: 30, speed: 0.8, xp: 200, gold: 100, size: 2, color: '#1abc9c', isBoss: true },
    demon_lord: { name: '恶魔领主', icon: '👿', hp: 800, atk: 45, speed: 1.0, xp: 350, gold: 150, size: 2.2, color: '#e74c3c', isBoss: true },
    ancient_dragon: { name: '远古巨龙', icon: '🐲', hp: 1200, atk: 60, speed: 0.9, xp: 500, gold: 200, size: 2.5, color: '#f39c12', isBoss: true },
    lich_king: { name: '巫妖王', icon: '💀', hp: 1000, atk: 55, speed: 0.7, xp: 450, gold: 180, size: 2, color: '#9b59b6', isBoss: true },
    abomination: { name: '憎恶', icon: '👾', hp: 1500, atk: 40, speed: 0.6, xp: 600, gold: 250, size: 3, color: '#2ecc71', isBoss: true }
};
...
const SKILL_SKINS = {
    // 斩击皮肤
    slash: [
        { id: 'slash_default', name: '标准斩击', skillId: 'slash', rarity: 'default', colors: ['#ffffff'], particleType: 'slash', description: '基础斩击特效' },
        { id: 'slash_fire', name: '烈焰斩', skillId: 'slash', rarity: 'rare', colors: ['#ff4500', '#ff8c00', '#ffd700'], particleType: 'fire_slash', description: '燃烧火焰斩击，附带灼烧粒子', unlockCondition: { achievement: 'first_blood' } },
        { id: 'slash_ice', name: '寒冰斩', skillId: 'slash', rarity: 'rare', colors: ['#00ffff', '#87ceeb', '#ffffff'], particleType: 'ice_slash', description: '冰冷寒冰斩击，冰冻粒子效果', unlockCondition: { achievement: 'ten_kills' } },
        { id: 'slash_lightning', name: '闪电斩', skillId: 'slash', rarity: 'epic', colors: ['#ffff00', '#00ffff', '#ffffff'], particleType: 'lightning_slash', description: '闪电环绕的斩击，电弧粒子', unlockCondition: { achievement: 'hundred_kills' } },
        { id: 'slash_void', name: '虚空斩', skillId: 'slash', rarity: 'legendary', colors: ['#8b00ff', '#ff00ff', '#000000'], particleType: 'void_slash', description: '来自虚空的黑暗斩击', unlockCondition: { achievement: 'thousand_kills' } }
    ],
    
    // 旋风斩皮肤
    whirlwind: [
        { id: 'whirlwind_default', name: '标准旋风', skillId: 'whirlwind', rarity: 'default', colors: ['#ffffff'], particleType: 'whirlwind', description: '基础旋风特效' },
        { id: 'whirlwind_fire', name: '火焰漩涡', skillId: 'whirlwind', rarity: 'rare', colors: ['#ff4500', '#ff6347'], particleType: 'fire_whirlwind', description: '燃烧的火焰漩涡', unlockCondition: { quest: 'daily_kill_50' } },
        { id: 'whirlwind_nature', name: '自然风暴', skillId: 'whirlwind', rarity: 'rare', colors: ['#228b22', '#32cd32'], particleType: 'nature_whirlwind', description: '自然之力的风暴', unlockCondition: { quest: 'daily_survive_10min' } },
        { id: 'whirlwind_shadow', name: '暗影旋风', skillId: 'whirlwind', rarity: 'epic', colors: ['#2f2f2f', '#808080'], particleType: 'shadow_whirlwind', description: '暗影能量的旋转风暴', unlockCondition: { achievement: 'speed_demon' } }
    ],
    
    // 火球术皮肤
    fireball: [
        { id: 'fireball_default', name: '标准火球', skillId: 'fireball', rarity: 'default', colors: ['#ff4500'], particleType: 'fireball', description: '基础火球特效' },
        { id: 'fireball_solar', name: '太阳火球', skillId: 'fireball', rarity: 'rare', colors: ['#ffd700', '#ff8c00', '#ffff00'], particleType: 'solar_fireball', description: '如太阳般耀眼的金色火球', unlockCondition: { level: 15 } },
        { id: 'fireball_void', name: '虚空火球', skillId: 'fireball', rarity: 'epic', colors: ['#8b00ff', '#4b0082'], particleType: 'void_fireball', description: '虚空能量的紫色火球', unlockCondition: { level: 25 } },
        { id: 'fireball_frost', name: '冰霜火球', skillId: 'fireball', rarity: 'epic', colors: ['#00ffff', '#ffffff', '#87ceeb'], particleType: 'frost_fireball', description: '冰火双重 paradox 效果', unlockCondition: { achievement: 'boss_slayer' } }
    ],
    
    // 闪电链皮肤
    lightning: [
        { id: 'lightning_default', name: '标准闪电', skillId: 'lightning', rarity: 'default', colors: ['#00ffff'], particleType: 'lightning', description: '基础闪电特效' },
        { id: 'lightning_plasma', name: '等离子链', skillId: 'lightning', rarity: 'rare', colors: ['#ff00ff', '#8b00ff'], particleType: 'plasma_lightning', description: '紫色等离子闪电链', unlockCondition: { level: 20 } },
        { id: 'lightning_solar', name: '太阳闪电', skillId: 'lightning', rarity: 'epic', colors: ['#ffd700', '#ff8c00'], particleType: 'solar_lightning', description: '金色太阳闪电链', unlockCondition: { achievement: 'lightning_reflex' } },
        { id: 'lightning_chaos', name: '混沌闪电', skillId: 'lightning', rarity: 'legendary', colors: ['#ff0000', '#00ff00', '#0000ff', '#ffff00'], particleType: 'chaos_lightning', description: '混沌多彩闪电，随机颜色', unlockCondition: { achievement: 'untouchable' } }
    ],
    
    // 霰弹枪皮肤
    shotgun: [
        { id: 'shotgun_default', name: '标准霰弹', skillId: 'shotgun', rarity: 'default', colors: ['#ffffff'], particleType: 'shotgun', description: '基础霰弹特效' },
        { id: 'shotgun_fire', name: '火焰弹丸', skillId: 'shotgun', rarity: 'rare', colors: ['#ff4500', '#ff8c00'], particleType: 'fire_shotgun', description: '燃烧的火焰弹丸', unlockCondition: { quest: 'weekly_kill_500' } },
        { id: 'shotgun_ice', name: '冰霜弹丸', skillId: 'shotgun', rarity: 'rare', colors: ['#00ffff', '#ffffff'], particleType: 'ice_shotgun', description: '冰冻弹丸，冰晶粒子', unlockCondition: { quest: 'weekly_extraction_5' } }
    ],
    
    // 环绕物皮肤
    orbit: [
        { id: 'orbit_default', name: '标准环绕', skillId: 'orbit', rarity: 'default', colors: ['#87ceeb'], particleType: 'orbit', description: '基础环绕特效' },
        { id: 'orbit_fire', name: '火焰环绕', skillId: 'orbit', rarity: 'rare', colors: ['#ff4500', '#ffd700'], particleType: 'fire_orbit', description: '燃烧的火焰球环绕', unlockCondition: { achievement: 'first_equip' } },
        { id: 'orbit_shadow', name: '暗影环绕', skillId: 'orbit', rarity: 'epic', colors: ['#2f2f2f', '#808080'], particleType: 'shadow_orbit', description: '暗影能量的黑暗球体', unlockCondition: { achievement: 'equipment_collector' } }
    ]
};
...
const TALENT_TREE = {
    // 第1层 - 基础天赋（直接可用）
    tier1: [
        { id: 'vitality', name: '生命力', description: '最大生命 +10%', icon: '❤️', maxLevel: 10, baseCost: 1, costPerLevel: 1, effect: { maxHp: 0.10 } },
        { id: 'attack_power', name: '攻击力', description: '伤害 +8%', icon: '⚔️', maxLevel: 10, baseCost: 1, costPerLevel: 1, effect: { damage: 0.08 } },
        { id: 'iron_skin', name: '铁甲', description: '护甲 +5', icon: '🛡️', maxLevel: 10, baseCost: 1, costPerLevel: 1, effect: { armor: 5 } },
        { id: 'swift_foot', name: '迅捷', description: '移速 +5%', icon: '💨', maxLevel: 5, baseCost: 1, costPerLevel: 1, effect: { moveSpeed: 0.05 } },
        { id: 'magnet', name: '磁吸', description: '拾取范围 +15%', icon: '🧲', maxLevel: 5, baseCost: 1, costPerLevel: 1, effect: { pickupRange: 0.15 } },
        { id: 'experience', name: '求知', description: '经验获取 +15%', icon: '📚', maxLevel: 5, baseCost: 1, costPerLevel: 1, effect: { xpBonus: 0.15 } },
        { id: 'greed', name: '贪婪', description: '金币获取 +15%', icon: '💰', maxLevel: 5, baseCost: 1, costPerLevel: 1, effect: { goldBonus: 0.15 } },
        { id: 'recovery', name: '恢复', description: '生命回复 +1/秒', icon: '💚', maxLevel: 5, baseCost: 1, costPerLevel: 1, effect: { lifeRegen: 1 } }
    ],
    
    // 第2层 - 专精（需要第1层任意2个解锁）
    tier2: [
        // 近战专精
        { id: 'melee_master', name: '近战大师', description: '近战伤害 +20%', icon: '🗡️', maxLevel: 5, baseCost: 2, costPerLevel: 2, effect: { meleeDamage: 0.20 }, requires: { tier1Count: 2 } },
        { id: 'slash_range', name: '斩击扩展', description: '近战范围 +15%', icon: '⚔️', maxLevel: 5, baseCost: 2, costPerLevel: 1, effect: { meleeRange: 0.15 }, requires: { tier1Count: 2 } },
        { id: 'attack_speed', name: '狂热', description: '攻击速度 +10%', icon: '⚡', maxLevel: 5, baseCost: 2, costPerLevel: 2, effect: { attackSpeed: 0.10 }, requires: { tier1Count: 2 } },
        
        // 远程专精
        { id: 'ranged_master', name: '神射手', description: '远程伤害 +20%', icon: '🏹', maxLevel: 5, baseCost: 2, costPerLevel: 2, effect: { rangedDamage: 0.20 }, requires: { tier1Count: 2 } },
        { id: 'bullet_speed', name: '速射', description: '子弹速度 +20%', icon: '💨', maxLevel: 3, baseCost: 2, costPerLevel: 1, effect: { projectileSpeed: 0.20 }, requires: { tier1Count: 2 } },
        { id: 'pierce', name: '穿透', description: '穿透 +1', icon: '🔱', maxLevel: 3, baseCost: 2, costPerLevel: 3, effect: { pierce: 1 }, requires: { tier1Count: 2 } },
        
        // 魔法专精
        { id: 'magic_master', name: '奥术掌控', description: '技能伤害 +20%', icon: '🔮', maxLevel: 5, baseCost: 2, costPerLevel: 2, effect: { skillDamage: 0.20 }, requires: { tier1Count: 2 } },
        { id: 'cooldown', name: '急速', description: '冷却缩减 +10%', icon: '⏱️', maxLevel: 3, baseCost: 2, costPerLevel: 3, effect: { cooldownReduction: 0.10 }, requires: { tier1Count: 2 } },
        { id: 'projectile', name: '多重射击', description: '投射物 +1', icon: '🎯', maxLevel: 2, baseCost: 2, costPerLevel: 5, effect: { projectileCount: 1 }, requires: { tier1Count: 2 } },
        
        // 生存专精
        { id: 'fortitude', name: '坚韧', description: '减伤 +5%', icon: '🏰', maxLevel: 5, baseCost: 2, costPerLevel: 2, effect: { damageReduction: 0.05 }, requires: { tier1Count: 2 } },
        { id: 'dodge', name: '闪避', description: '闪避率 +5%', icon: '🌀', maxLevel: 3, baseCost: 2, costPerLevel: 3, effect: { dodge: 0.05 }, requires: { tier1Count: 2 } },
        { id: 'critical_resist', name: '抗性', description: '暴击抵抗 +10%', icon: '💎', maxLevel: 3, baseCost: 2, costPerLevel: 2, effect: { criticalResist: 0.10 }, requires: { tier1Count: 2 } }
    ],
    
    // 第3层 - 高级天赋（需要第2层对应专精3个解锁）
    tier3: [
        { id: 'lightning_reflex', name: '闪电反射', description: '首次受击无敌1秒（每30秒）', icon: '⚡', maxLevel: 1, baseCost: 5, costPerLevel: 5, effect: { lightningReflex: 1 }, requires: { tier2Count: 3, specific: ['attack_speed', 'swift_foot'] } },
        { id: 'vampire_aura', name: '吸血光环', description: '击杀回复5%最大生命', icon: '🧛', maxLevel: 3, baseCost: 5, costPerLevel: 3, effect: { lifeSteal: 0.05 }, requires: { tier2Count: 3, specific: ['melee_master', 'vitality'] } },
        { id: 'critical_master', name: '暴击大师', description: '暴击率 +10%，暴击伤害 +30%', icon: '💥', maxLevel: 3, baseCost: 5, costPerLevel: 4, effect: { criticalChance: 0.10, criticalDamage: 0.30 }, requires: { tier2Count: 3, specific: ['attack_power', 'ranged_master'] } },
        { id: 'elemental_damage', name: '元素附加', description: '攻击附带20点元素伤害', icon: '🔥', maxLevel: 5, baseCost: 5, costPerLevel: 3, effect: { elementalDamage: 20 }, requires: { tier2Count: 3, specific: ['magic_master'] } },
        { id: 'thorns', name: '荆棘', description: '反弹30%近战伤害', icon: '🌵', maxLevel: 3, baseCost: 5, costPerLevel: 4, effect: { thorns: 0.30 }, requires: { tier2Count: 3, specific: ['iron_skin', 'fortitude'] } },
        { id: 'executioner', name: '处决者', description: '对低于30%生命敌人伤害 +50%', icon: '☠️', maxLevel: 1, baseCost: 5, costPerLevel: 5, effect: { execute: 0.50 }, requires: { tier2Count: 3, specific: ['melee_master', 'slash_range'] } },
        { id: 'phoenix_shield', name: '凤凰护盾', description: '生命低于20%时获得50%减伤（持续5秒，每60秒）', icon: '🔰', maxLevel: 1, baseCost: 5, costPerLevel: 5, effect: { phoenixShield: 1 }, requires: { tier2Count: 3, specific: ['fortitude', 'vitality'] } },
        { id: 'treasure_hunter', name: '宝藏猎人', description: '稀有掉落率 +30%', icon: '💎', maxLevel: 3, baseCost: 5, costPerLevel: 3, effect: { rareDrop: 0.30 }, requires: { tier2Count: 3, specific: ['greed', 'experience'] } }
    ],
    
    // 第4层 - 终极天赋（需要第3层任意6个解锁）
    tier4: [
        { id: 'phoenix_rebirth', name: '凤凰涅槃', description: '死亡时复活一次（每局1次）', icon: '🔥', maxLevel: 1, baseCost: 10, costPerLevel: 10, effect: { phoenixRebirth: 1 }, requires: { tier3Count: 6 } },
        { id: 'time_warp', name: '时间扭曲', description: '所有技能冷却 -30%', icon: '⏳', maxLevel: 1, baseCost: 10, costPerLevel: 10, effect: { timeWarp: 0.30 }, requires: { tier3Count: 6 } },
        { id: 'immortal_body', name: '不灭之躯', description: '最大生命 +50%，护甲 +20', icon: '🏛️', maxLevel: 1, baseCost: 10, costPerLevel: 10, effect: { maxHp: 0.50, armor: 20 }, requires: { tier3Count: 6 } },
        { id: 'destroyer', name: '毁灭化身', description: '所有伤害 +40%', icon: '💀', maxLevel: 1, baseCost: 10, costPerLevel: 10, effect: { allDamage: 0.40 }, requires: { tier3Count: 6 } }
    ]
};
...
let persistentData = {
    ...
    totalExtractions: 0,
    achievements: [],     // 已完成的成就
    unlockedSkins: ['slash_default', 'whirlwind_default', 'fireball_default', 'lightning_default', 'shotgun_default', 'orbit_default'],
    equippedSkins: {},
    visualSettings: { screenShake: true, damageNumbers: true, particleEffects: true },
    runStats: {           // 当前局统计
        timeAlive: 0,
        kills: 0,
        level: 1,
    ...
    for (const [skillId, skins] of Object.entries(SKILL_SKINS)) {
        for (const skin of skins) {
            ...
            if (skin.unlockCondition) {
                if (skin.unlockCondition.achievement && persistentData.achievements.includes(skin.unlockCondition.achievement)) unlocked = true;
                if (skin.unlockCondition.level && playerLevel >= skin.unlockCondition.level) unlocked = true;
                if (skin.unlockCondition.quest) {
                    const claimed = (persistentData.dailyQuestClaimed || []).includes(skin.unlockCondition.quest) || 
                                   (persistentData.weeklyQuestClaimed || []).includes(skin.unlockCondition.quest);
...
function getSlotName(slot) {
    const names = { weapon: '武器', chest: '胸甲', boots: '鞋子', accessory: '饰品' };
...
function getStatName(key) {
    const names = {
        damage: '伤害', maxHp: '最大生命', armor: '护甲', attackSpeed: '攻击速度',
        criticalChance: '暴击率', criticalDamage: '暴击伤害', meleeDamage: '近战伤害',
        rangedDamage: '远程伤害', magicDamage: '魔法伤害', moveSpeed: '移速',
        dodge: '闪避', damageReduction: '减伤', pickupRange: '拾取范围',
        lifeRegen: '生命回复', cooldownReduction: '冷却缩减', skillDamage: '技能伤害',
        projectileCount: '投射物', pierce: '穿透', xpBonus: '经验加成', goldBonus: '金币加成'
    };
    return names[key] || key;
}

function formatStatValue(key, value) {
    const percentStats = ['attackSpeed', 'criticalChance', 'criticalDamage', 'moveSpeed', 'dodge', 
                          'damageReduction', 'pickupRange', 'cooldownReduction', 'skillDamage', 
                          'xpBonus', 'goldBonus'];
...
function addFloatingText(x, y, text, color) {
    gameState.floatingTexts.push({ x: x*CONFIG.TILE_SIZE, y: y*CONFIG.TILE_SIZE-10, text, color, life: 40, maxLife: 40, vy: -2 });
}
...
function spawnParticles(x, y, color, count=10) {
    for (let i = 0; i < count; i++) {
        gameState.particles.push({
            ...
            life: rand(15,30), maxLife: 30, color, size: rand(2,5)
        });
    }
}
...
function updateEffects() {
    ...
    gameState.floatingTexts = gameState.floatingTexts.filter(ft => { ft.y += ft.vy; ft.life--; return ft.life > 0; });
    gameState.lightnings = gameState.lightnings.filter(l => { l.life--; return l.life > 0; });
...
function initPlayer() {
    ...
    gameState.playerStats.maxHp = CONFIG.PLAYER.BASE_HP + (talentBonuses.maxHp || 0);
    ...
    if (talentBonuses.damageReduction) gameState.playerStats.damageReduction += talentBonuses.damageReduction;
    if (talentBonuses.criticalChance) gameState.playerStats.criticalChance = talentBonuses.criticalChance;
    if (talentBonuses.lifeRegen) gameState.playerStats.lifeRegen = talentBonuses.lifeRegen;
    if (talentBonuses.goldBonus) gameState.playerStats.goldBonus = talentBonuses.goldBonus;
...
function updateEquipmentStats() {
    ...
    const equipmentList = Object.values(gameState.equipment).filter(e => e !== null);
    gameState.playerStats.applyBonuses(equipmentList, { level: gameState.player.level });
}
...
function autoPickup() {
    ...
    let changed = false;
    const toPickup = gameState.groundItems.filter(item => dist(item.x, item.y, p.x, p.y) <= range);
    for (const item of toPickup) {
        if (item.type === 'gold') {
            ...
            if (p.inventory.length < (persistentData.inventorySize || 25)) {
                ...
                addLog(`获得装备: ${item.equipment.icon} ${item.equipment.name}`, 'item');
                changed = true;
...
function equipItem(inventoryIndex) {
    ...
    if (!p.inventory[inventoryIndex]) {
        console.log('索引', inventoryIndex, '不存在，当前库存:', p.inventory.length);
        return;
    }
    ...
    if (gameState.equipment[slot]) {
        ...
        addLog(`卸下 ${gameState.equipment[slot].icon} ${gameState.equipment[slot].name}`, 'info');
    }
...
function checkLevelUp() {
    ...
    while (p.xp >= p.xpToNext) {
        p.xp -= p.xpToNext;
        p.level++;
        p.xpToNext = Math.floor(CONFIG.LEVEL.BASE_XP * CONFIG.LEVEL.MULTIPLIER ** (p.level - 1));
...
function showLevelUpChoices() {
    ...
    for (let i = 0; i < choices.length; i++) {
        ...
        const ownedSkillIds = gameState.player.skills.filter(s => s.type !== 'stat' && s.type !== 'special').map(s => s.id);
        ...
        if (owned && SKILLS[card.id]) {
            // 已有技能 - 显示升级信息
            const baseSkill = SKILLS[card.id];
            const currentDmg = existing.damage;
            const nextDmg = Math.floor(currentDmg * 1.25);
            const currentRange = existing.range || baseSkill.range;
            const nextRange = (currentRange * 1.1).toFixed(1);
            
            statsHtml = `<div class="card-stats">当前 Lv.${currentLevel} | 伤害: ${currentDmg} | 范围: ${currentRange}</div>`;
            nextHtml = `<div class="card-next">➤ 升级到 Lv.${nextLevel}: 伤害 ${nextDmg}, 范围 ${nextRange}</div>`;
            
            // 检查是否接近进化等级
            const evoData = SKILL_EVOLUTION[card.id];
            if (evoData) {
                const nextEvo = evoData.evolutions.find(e => e.level > currentLevel);
                if (nextEvo) {
                    nextHtml += `<div class="card-next" style="color: #ff69b4;">★ 进化在 Lv.${nextEvo.level} - 还差 ${nextEvo.level - nextLevel} 级</div>`;
                }
            }
        } else if (!owned && card.type === 'skill') {
            // 新技能 - 显示基础信息
            statsHtml = `<div class="card-stats">伤害: ${card.damage} | 冷却: ${(card.cooldown/1000).toFixed(1)}s | 范围: ${card.range || '-'}</div>`;
        ...
        div.innerHTML = `
            ...
            ${statsHtml}
            ${nextHtml}
            <div class="card-type">${card.type === 'skill' ? (owned ? '🔼 技能升级' : '✨ 新技能') : card.type === 'stat' ? '💪 属性强化' : '⭐ 特殊能力'}</div>
        `;
...
function selectUpgrade(card) {
    ...
    console.log('当前技能列表:', p.skills.map(s => s.id));

    // 检查是否是技能（type 包含 skill 或者是 SKILLS 中定义的技能类型）
    const isSkill = card.type === 'skill' || SKILLS[card.id];
    console.log('是否为技能类型:', isSkill);

    if (isSkill) {
        const existing = p.skills.find(s => s.id === card.id);
        console.log('现有技能:', existing ? existing.id : '新技能');
        ...
        if (existing) {
            ...
            if (existing.radius) existing.radius += 0.3;
            addLog(`${card.icon} ${card.name} -> Lv.${existing.level}`, 'success');
            if (card.id === 'orbit') gameState.orbitals = [];
            console.log('技能升级:', card.name, '等级:', existing.level, 'cooldown:', existing.cooldown);
            
            // 检查是否触发进化
            checkSkillEvolution(existing);
        } else {
            const newSkill = { ...card, level: 1, timer: 0 };
            console.log('创建新技能对象:', newSkill);
            p.skills.push(newSkill);
            addLog(`获得技能: ${card.icon} ${card.name}`, 'success');
            if (card.id === 'orbit') gameState.orbitals = [];
            console.log('获得新技能:', card.name, 'cooldown:', newSkill.cooldown, 'type:', newSkill.type);
            console.log('更新后技能列表:', p.skills.map(s => ({ id: s.id, name: s.name, cooldown: s.cooldown })));
...
function updateSkills(dt) {
    ...
    if (!updateSkills.hasLogged) {
        console.log('玩家技能列表:', p.skills.map(s => ({ name: s.name, cooldown: s.cooldown, type: s.type })));
    ...
    for (const skill of p.skills) {
        if (skill.cooldown === 0 || skill.type === 'orbit') {
            ...
            if (!updateSkills.skipLogged) {
                console.log('跳过技能 (cooldown=0 或 orbit):', skill.name, 'cooldown:', skill.cooldown);
        ...
        if (skill.timer >= actualCd) {
            console.log('技能就绪:', skill.name, 'timer:', Math.floor(skill.timer), 'cd:', Math.floor(actualCd));
            skill.timer = 0;
    ...
    if (orbitSkills.length > 0) {
        ...
        if (gameState.orbitals.length !== count || gameState.orbitals.length === 0) {
            gameState.orbitals = [];
            for (let i = 0; i < count; i++) {
        ...
        for (const orb of gameState.orbitals) {
            ...
            for (const enemy of [...gameState.enemies]) {
                if (dist(enemy.x, enemy.y, ox, oy) < enemy.size * 0.5 + orb.size && orb.hitTimer <= 0) {
...
function useSkill(skill, stats) {
    ...
    switch (skill.type) {
        ...
        case 'ranged': {
            ...
            if (skill.id === 'shotgun' && count >= 5) {
                ...
                for (const target of targets) {
                    ...
                    const result = stats.calculateDamage(skill.damage, skill.explosive ? 'magic' : 'ranged');
                    gameState.projectiles.push({
                        x: p.x, y: p.y,
                        vx: Math.cos(angle) * skill.speed,
                        vy: Math.sin(angle) * skill.speed,
        ...
        case 'mine': {
            gameState.mines.push({ x: p.x, y: p.y, damage: skill.damage, duration: skill.duration, radius: skill.radius });
            break;
        }
        case 'lightning': {
            const targets = gameState.enemies
            ...
            if (targets.length > 0) {
                ...
                for (const t of targets) {
                    gameState.lightnings.push({ x1: lx, y1: ly, x2: t.x, y2: t.y, life: 12 });
...
function damageEnemy(enemy, damage, isCrit) {
    enemy.hp -= damage;
    enemy.hitFlash = 5;
    addFloatingText(enemy.x, enemy.y, isCrit ? `暴击! ${Math.floor(damage)}` : `-${Math.floor(damage)}`, isCrit ? '#f1c40f' : '#e74c3c');
...
function killEnemy(enemy) {
    ...
    gameState.xpOrbs.push({ x: enemy.x + randFloat(-0.3, 0.3), y: enemy.y + randFloat(-0.3, 0.3), value: enemy.xp * (1 + stats.xpBonus) });
    gameState.groundItems.push({ type: 'gold', x: enemy.x + randFloat(-0.3, 0.3), y: enemy.y + randFloat(-0.3, 0.3), value: enemy.gold * (1 + stats.goldBonus) });
    
    // 装备掉落
    if (chance(CONFIG.EQUIPMENT.DROP_CHANCE * 100)) {
        const equip = generateEquipment(p.level);
        if (equip) {
            gameState.groundItems.push({ type: 'equipment', x: enemy.x, y: enemy.y, icon: equip.icon, name: equip.name, equipment: equip });
            addLog(`${enemy.name} 掉落了 ${equip.icon} ${RARITY[equip.rarity].name} ${equip.name}!`, 'item');
    ...
    if (chance(3)) {
        gameState.groundItems.push({ type: 'heal', x: enemy.x, y: enemy.y, icon: '❤️', name: '生命药水', heal: 30 });
    }
...
function spawnEnemies() {
    ...
    const atkMult = CONFIG.ENEMY.BASE_ATK_MULT + (timeMinutes * CONFIG.ENEMY.ATK_SCALE_PER_MIN);
    const hpMult = CONFIG.ENEMY.BASE_HP_MULT + (timeMinutes * CONFIG.ENEMY.HP_SCALE_PER_MIN);
    ...
    for (let i = 0; i < count; i++) {
        ...
        const d = randFloat(CONFIG.ENEMY.SPAWN_RADIUS_MIN, CONFIG.ENEMY.SPAWN_RADIUS_MAX);
        const ex = p.x + Math.cos(angle) * d;
        const ey = p.y + Math.sin(angle) * d;

        if (ex < 1 || ex >= CONFIG.ARENA_SIZE-1 || ey < 1 || ey >= CONFIG.ARENA_SIZE-1) continue;
        ...
        gameState.enemies.push({
            type, x: ex, y: ey,
            hp: Math.max(10, finalHp),
            maxHp: Math.max(10, finalHp),
            atk: Math.max(2, finalAtk),
            speed: tmpl.speed,
            xp: Math.floor(tmpl.xp * (1 + timeMinutes * 0.1)),
            gold: Math.floor(tmpl.gold * (1 + timeMinutes * 0.1)),
            icon: tmpl.icon, size: tmpl.size, color: tmpl.color,
            hitFlash: 0
        });
    }
}
...
function spawnBoss() {
    ...
    gameState.enemies.push({
        type: bossType, x: bx, y: by,
        hp: Math.floor(tmpl.hp * hpMult),
        maxHp: Math.floor(tmpl.hp * hpMult),
        atk: Math.floor(tmpl.atk * atkMult),
        speed: tmpl.speed,
        xp: Math.floor(tmpl.xp * (1 + timeMinutes * 0.1)),
        gold: Math.floor(tmpl.gold * (1 + timeMinutes * 0.1)),
        icon: tmpl.icon, size: tmpl.size, color: tmpl.color,
...
function spawnChest() {
    ...
    if (cx < 2 || cx >= CONFIG.ARENA_SIZE-2 || cy < 2 || cy >= CONFIG.ARENA_SIZE-2) return;
    ...
    gameState.chests.push({ x: cx, y: cy, ...chest, life: CONFIG.CHEST.LIFETIME });
}
...
function spawnSearchPoint() {
    ...
    if (sx < 2 || sx >= CONFIG.ARENA_SIZE-2 || sy < 2 || sy >= CONFIG.ARENA_SIZE-2) return;
...
function searchPointSuccess(sp) {
    ...
    // 决定掉落数量
    const dropCount = rand(CONFIG.SEARCH_POINT.DROP_COUNT_MIN, CONFIG.SEARCH_POINT.DROP_COUNT_MAX);
    ...
    for (let i = 0; i < dropCount; i++) {
        ...
        if (roll < CONFIG.SEARCH_POINT.EQUIPMENT_CHANCE * 100) {
            ...
            if (equip) {
                ...
                addLog(`发现 ${RARITY[equip.rarity].name} ${equip.icon} ${equip.name}!`, 'item');
                dropped = true;
            }
        }
        
        // 40% 掉落血药
        if (!dropped && roll < (CONFIG.SEARCH_POINT.EQUIPMENT_CHANCE + CONFIG.SEARCH_POINT.HEAL_CHANCE) * 100) {
...
function updateEntities(dt) {
    ...
    gameState.projectiles = gameState.projectiles.filter(proj => {
        proj.x += proj.vx * dt;
        proj.y += proj.vy * dt;
        if (dist(proj.x, proj.y, proj.startX, proj.startY) > proj.range) return false;
    ...
    gameState.mines = gameState.mines.filter(mine => {
        ...
        for (const enemy of gameState.enemies) {
            if (dist(enemy.x, enemy.y, mine.x, mine.y) < mine.radius) {
                for (const e of [...gameState.enemies]) {
                    if (dist(e.x, e.y, mine.x, mine.y) < mine.radius * 2) damageEnemy(e, mine.damage, false);
                }
    ...
    for (const enemy of gameState.enemies) {
        ...
        if (d > 0.5) {
            ...
            for (const other of gameState.enemies) {
                ...
                if (dist(nx, ny, other.x, other.y) < 0.6) { blocked = true; break; }
            }
        ...
        if (d < 0.7) {
            ...
            if (!stats.isAlive()) { gameOver(); return; }
        }
...
function render() {
    ...
    ctx.lineWidth = 3;
    ctx.strokeRect(0 - camX, 0 - camY, CONFIG.ARENA_SIZE * ts, CONFIG.ARENA_SIZE * ts);
    ...
    for (const sp of gameState.searchPoints) {
        ...
        // 搜索范围圈
        ctx.strokeStyle = sp.searching ? 'rgba(46, 204, 113, 0.6)' : 'rgba(155, 89, 182, 0.4)';
        ctx.lineWidth = 2;
        ctx.beginPath();
    ...
    for (const w of gameState.whirlwinds) {
        ...
        console.log('渲染单个旋风:', 'x:', w.x, 'y:', w.y, 'alpha:', alpha, 'radius:', radius);
    ...
    for (const proj of gameState.projectiles) {
        ...
        if (proj.explosive) {
            ...
            ctx.beginPath();
            ctx.arc(sx - proj.vx * 3, sy - proj.vy * 3, proj.size * ts, 0, Math.PI * 2);
            ctx.fill();
            ...
            ctx.fill();
            ctx.fillStyle = proj.explosive ? 'rgba(255, 102, 0, 0.5)' : 'rgba(241, 196, 15, 0.3)';
            ctx.beginPath();
            ctx.arc(sx - proj.vx * 2, sy - proj.vy * 2, proj.size * ts / 3, 0, Math.PI * 2);
            ctx.fill();
        }
    }
...
function renderMinimap() {
    ...
    for (const e of gameState.enemies) minimapCtx.fillRect(e.x * ts - 1, e.y * ts - 1, 2, 2);

    minimapCtx.fillStyle = '#f1c40f';
    for (const c of gameState.chests) minimapCtx.fillRect(c.x * ts - 1, c.y * ts - 1, 3, 3);
...
function updateUI() {
    ...
    document.getElementById('hp-display').textContent = `${Math.floor(stats.currentHp)}/${stats.maxHp}`;
    ...
    document.getElementById('xp-display').textContent = `${Math.floor(p.xp)}/${p.xpToNext}`;
    ...
    if (slotsDisplay) slotsDisplay.textContent = persistentData.inventorySize || 25;
    ...
    for (const slot of Object.values(EQUIPMENT_SLOT)) {
        ...
        if (slotDiv) {
            ...
            if (gameState.equipment[slot]) {
                ...
                const slotNames = { weapon: '武器', chest: '胸甲', boots: '鞋子', accessory: '饰品' };
    ...
    if (statsDiv) {
        ...
        statsDiv.innerHTML = Object.entries(allStats).map(([name, value]) => `
            <div class="stat-row">
    ...
    if (skillsList) {
        ...
        for (const skill of p.skills) {
            ...
            // 检查是否已进化
            const evolutionName = skill.evolution ? skill.evolution.split('_').map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ') : '';
    ...
    function showSkillTooltip(element, skill) {
        ...
        // 构建提示内容
        let statsHtml = '';
        if (skill.damage) statsHtml += `<div><span>伤害:</span><span>${skill.damage}</span></div>`;
        if (skill.range) statsHtml += `<div><span>范围:</span><span>${skill.range}</span></div>`;
        if (skill.cooldown) statsHtml += `<div><span>冷却:</span><span>${(skill.cooldown / 1000).toFixed(1)}s</span></div>`;
        if (skill.projectileCount) statsHtml += `<div><span>投射物:</span><span>${skill.projectileCount}</span></div>`;
        if (skill.chainCount) statsHtml += `<div><span>连锁数:</span><span>${skill.chainCount}</span></div>`;
        if (skill.count) statsHtml += `<div><span>数量:</span><span>${skill.count}</span></div>`;
        if (skill.radius) statsHtml += `<div><span>半径:</span><span>${skill.radius}</span></div>`;
        if (skill.speed) statsHtml += `<div><span>速度:</span><span>${skill.speed}</span></div>`;
        if (skill.pierce) statsHtml += `<div><span>穿透:</span><span style="color:#2ecc71;">是</span></div>`;
        if (skill.explosive) statsHtml += `<div><span>爆炸:</span><span style="color:#2ecc71;">是</span></div>`;
...
function showItemTooltip(e, item) {
    ...
    const weaponTypeName = equip.weaponType ? getWeaponTypeName(equip.weaponType) : '';
...
function updateTalentUI() {
    ...
    if (pointsSpan) {
        ...
        pointsSpan.previousSibling && (pointsSpan.previousSibling.textContent = '天赋点: ');
    }

    // 显示总统计信息
    const statsDiv = document.createElement('div');
    statsDiv.style.cssText = 'background: #0d0d0d; border: 1px solid #333; border-radius: 6px; padding: 10px; margin-bottom: 15px;';
    statsDiv.innerHTML = `
    ...
    // 计算已解锁的各层级数量
    const tierCounts = {
        tier1: Object.keys(persistentData.talents || {}).filter(id => TALENT_TREE.tier1.find(t => t.id === id)).length,
        tier2: 0,
        tier3: 0,
        tier4: 0
    };
    ...
    for (const [tierKey, talents] of Object.entries(TALENT_TREE)) {
        ...
        titleDiv.style.cssText = 'margin: 15px 0 10px; padding: 8px; background: #1a1a2e; border-radius: 4px;';
        titleDiv.innerHTML = `
        ...
        for (const talent of talents) {
            ...
            item.onmouseleave = () => {
                if (level === 0) item.style.borderColor = canAfford && isUnlockedTier ? '#555' : '#333';
...
function getTierUnlockReq(tierKey) {
    switch(tierKey) {
        case 'tier1': return '始终可用';
        case 'tier2': return '解锁第1层任意2个天赋';
        case 'tier3': return '解锁第2层任意3个天赋';
        case 'tier4': return '解锁第3层任意6个天赋';
        default: return '';
    }
}
...
function gameLoop(timestamp) {
    ...
    if (gameState.running && !gameState.paused) {
        ...
        if (timestamp - gameState.lastSearchTime > CONFIG.SEARCH_POINT.SPAWN_INTERVAL) {
            spawnSearchPoint();
            gameState.lastSearchTime = timestamp;
        }
        
        // Boss生成检查
        if (gameState.time > CONFIG.BOSS.MIN_TIME && 
...
function gameOver() {
    ...
    persistentData.totalPlayTime = (persistentData.totalPlayTime || 0) + gameState.time;
...
function updateAchievementUI() {
    ...
    for (const [category, achs] of Object.entries(categories)) {
        ...
        gridDiv.style.cssText = 'display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 10px;';
        ...
        for (const ach of achs) {
            ...
            achDiv.innerHTML = `
                ...
                ${isUnlocked ? '<div style="color: #2ecc71; font-size: 10px; margin-top: 5px;">✓ 已完成</div>' : 
...
function updateSkinUI() {
    ...
    for (const [skillId, skins] of Object.entries(SKILL_SKINS)) {
        ...
        const titleDiv = document.createElement('div');
        titleDiv.style.cssText = 'color: #ff69b4; font-size: 18px; font-weight: bold; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #333;';
        titleDiv.textContent = `${skill.icon} ${skill.name} (${skins.length}个皮肤)`;
        skillDiv.appendChild(titleDiv);
        
        const gridDiv = document.createElement('div');
        gridDiv.style.cssText = 'display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 10px;';
...
function updateQuestUI() {
    ...
    dailyTitle.style.cssText = 'color: #3498db; font-size: 18px; font-weight: bold; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #333;';
    ...
    for (const questId of dailyQuestIds) {
        ...
        const isClaimed = persistentData.dailyQuestClaimed?.includes(questId) || false;
        ...
        questDiv.innerHTML = `
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                ...
                ${isClaimed ? '<div style="color: #888; font-size: 12px; font-weight: bold;">已领取</div>' : 
                  isComplete ? '<button style="padding: 5px 15px; background: #2ecc71; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: bold;" onclick="claimQuestReward(\'' + questId + '\'); updateQuestUI();">领取</button>' : ''}
            </div>
    ...
    weeklyTitle.style.cssText = 'color: #9b59b6; font-size: 18px; font-weight: bold; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #333;';
    ...
    for (const questId of weeklyQuestIds) {
        ...
        const isComplete = progress >= quest.target;
        const isClaimed = persistentData.weeklyQuestClaimed?.includes(questId) || false;
        ...
        questDiv.innerHTML = `
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                ...
                ${isClaimed ? '<div style="color: #888; font-size: 12px; font-weight: bold;">已领取</div>' : 
                  isComplete ? '<button style="padding: 5px 15px; background: #9b59b6; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: bold;" onclick="claimQuestReward(\'' + questId + '\'); updateQuestUI();">领取</button>' : ''}
            </div>
            <div style="margin-top: 8px;">
                <div style="display: flex; justify-content: space-between; font-size: 11px; margin-bottom: 3px;">
                    <span style="color: #888;">进度</span>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (achievementBtn) achievementBtn.addEventListener('click', showAchievementPanel);
    ...
    if (closeInventoryBtn) closeInventoryBtn.addEventListener('click', toggleInventory);
    if (closeShopBtn) closeShopBtn.addEventListener('click', closeShop);
    if (closeDiamondShopBtn) closeDiamondShopBtn.addEventListener('click', closeDiamondShop);
    if (closeTalentBtn) closeTalentBtn.addEventListener('click', hideTalentTree);
    if (closeAchievementBtn) closeAchievementBtn.addEventListener('click', hideAchievementPanel);
...
function updateInventoryBadge() {
    ...
    // 计算新物品数量（未查看过的物品）
    const newItems = gameState.player.inventory.filter(item => item && !item.seen).length;
...
function updateInventoryUI() {
    ...
    for (let i = 0; i < invSize; i++) {
        ...
        if (item) {
            ...
            const sellPrice = item.equipment ? Math.floor(item.equipment.rarity === 'legendary' ? 100 : item.equipment.rarity === 'epic' ? 60 : item.equipment.rarity === 'rare' ? 35 : item.equipment.rarity === 'uncommon' ? 20 : 10) : 5;
...
function generateMerchantProducts() {
    const products = [];
    const totalWeight = Object.values(MERCHANT_CONFIG.PRODUCTS).reduce((sum, cat) => sum + cat.weight, 0);
...
function generateShopProducts() {
    ...
    for (let i = 0; i < count; i++) {
        ...
        if (type === 'skill') {
            ...
            const attrs = [
                { name: '伤害强化', icon: '💪', desc: '伤害 +20%', effect: { damage: 20 }, price: rand(50, 100) },
                { name: '攻速强化', icon: '⚡', desc: '攻击速度 +15%', effect: { attackSpeed: 15 }, price: rand(50, 100) },
                { name: '生命强化', icon: '❤️', desc: '最大生命 +30', effect: { maxHp: 30 }, price: rand(40, 80) },
                { name: '移速强化', icon: '💨', desc: '移动速度 +20%', effect: { moveSpeed: 20 }, price: rand(50, 90) },
                { name: '回复强化', icon: '💚', desc: '每秒回复 2 HP', effect: { lifeRegen: 2 }, price: rand(60, 120) }
            ];
            const attr = attrs[rand(0, attrs.length - 1)];
            Object.assign(product, attr);
        } else if (type === 'consumable') {
            const consumables = [
                { name: '生命药水', icon: '🧪', desc: '恢复 50% HP', effect: { healPercent: 0.5 }, price: rand(30, 60) },
                { name: '护盾药水', icon: '🛡️', desc: '获得 30 点护盾', effect: { shield: 30 }, price: rand(40, 70) },
                { name: '经验药水', icon: '📚', desc: '获得 100 经验', effect: { xp: 100 }, price: rand(50, 80) }
            ];
...
function buyShopProduct(index) {
    ...
    if (product.type === 'skill') {
        ...
        if (existing) {
            ...
            existing.damage = Math.floor(existing.damage * 1.25);
            if (existing.range) existing.range *= 1.1;
            addLog(`${product.icon} ${product.name} -> Lv.${existing.level}`, 'success');
            checkSkillEvolution(existing);
        } else {
...
function applyShopConsumable(effect) {
    ...
    if (effect.healPercent) {
        stats.currentHp = Math.min(stats.maxHp, stats.currentHp + stats.maxHp * effect.healPercent);
    }
    if (effect.shield) {
...
function updateDiamondShopUI() {
    document.getElementById('diamond-count').textContent = persistentData.diamonds || 0;
    ...
    const products = [
        {
            name: '背包扩展 +5格',
            icon: '🎒',
            description: '增加5个背包格子 (当前: ' + (persistentData.inventorySize || 25) + '格)',
            price: 300,
        ...
        },
        {
            name: '背包扩展 +5格',
            icon: '🎒',
            description: '增加5个背包格子 (购买后: ' + ((persistentData.inventorySize || 25) + 5) + '格)',
            price: 500,
...
function buyDiamondProduct(product) {
    ...
    if (product.effect === 'inventory_slots') {
        ...
        addLog(`背包扩展成功! 现在拥有 ${persistentData.inventorySize} 格`, 'success');
...
function selectEvolution(skill, choice) {
    ...
    // 应用进化效果 - 基础属性
    if (choice.effect.damageMult) skill.damage = Math.floor(skill.damage * choice.effect.damageMult);
    if (choice.effect.rangeMult) skill.range = (skill.range || 1) * choice.effect.rangeMult;
    if (choice.effect.cooldownMult) skill.cooldown = Math.floor(skill.cooldown * choice.effect.cooldownMult);
    
    // 应用特殊效果
    if (choice.effect.chainCount !== undefined) skill.chainCount = (skill.chainCount || 4) + choice.effect.chainCount;
    if (choice.effect.projectileCount !== undefined) {
        if (choice.effect.projectileCount > 0) skill.projectileCount = (skill.projectileCount || 1) + choice.effect.projectileCount;
        else skill.projectileCount = Math.max(1, (skill.projectileCount || 5) + choice.effect.projectileCount);
    }
    if (choice.effect.spreadMult !== undefined) skill.spread = (skill.spread || 30) * choice.effect.spreadMult;
    if (choice.effect.speedMult !== undefined) skill.speed = (skill.speed || 8) * choice.effect.speedMult;
    if (choice.effect.sizeMult !== undefined) skill.size = (skill.size || 1) * choice.effect.sizeMult;
    if (choice.effect.explosionMult !== undefined) skill.explosionRadius = (skill.explosionRadius || 2) * choice.effect.explosionMult;
    
    // 应用特殊标记
    if (choice.effect.pierce) skill.pierce = true;
    if (choice.effect.explosive) skill.explosive = true;
    if (choice.effect.explosionRadius) skill.explosionRadius = choice.effect.explosionRadius;
    if (choice.effect.addBurn) skill.addBurn = true;
    if (choice.effect.burnDuration) skill.burnDuration = choice.effect.burnDuration;
    ...
    if (choice.effect.stunDuration) skill.stunDuration = choice.effect.stunDuration;
    if (choice.effect.forkChain) skill.forkChain = true;
    if (choice.effect.summonCloud) skill.summonCloud = true;
    if (choice.effect.cloudDuration) skill.cloudDuration = choice.effect.cloudDuration;
    ...
    if (choice.effect.fireDuration) skill.fireDuration = choice.effect.fireDuration;
